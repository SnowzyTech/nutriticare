    ...
    <Link key={post.id} href={`/blog/${post.slug}`}>
      ...
      >
        <div className="relative h-79 overflow-hidden">
          <img
            src={post.featured_image || "/health-wellness.png"}
            alt={post.title}
            loading="lazy"
            className="w-full h-full bg-gradient-to-br from-primary/20 to-primary/10 object-cover transition-transform duration-500 ease-out group-hover:scale-105"
          />
        </div>
